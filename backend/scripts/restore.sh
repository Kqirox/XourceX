#!/usr/bin/env bash
# =============================================================================
# XourceX PostgreSQL Backup Restoration Script
# =============================================================================
# Restores the XOURCEX database from a compressed pg_dump file.
#
# Usage:
...
if [[ "${BACKUP_FILE}" == *.gpg ]]; then
    ...
    DECRYPTED="/tmp/xourcex-restore-$(date +%s).sql.gz"
