...
This document outlines the security measures implemented for container images used in the XourceX backend, specifically addressing image scanning and signing as part of our CI/CD pipeline.
