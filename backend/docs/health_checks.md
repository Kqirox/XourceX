...
The XourceX backend provides the following health check endpoints for use by load balancers, orchestrators (e.g., Kubernetes), and monitoring systems.
