...
The Legacy Content Upload feature allows XourceX users to securely upload and store various types of media files (video, audio, text, documents) as part of their digital inheritance. Files are validated, hashed, and stored with proper access controls.
...
STORAGE_PATH=/var/xourcex/storage
```
