...
impl WillSignatureService {
    ...
    pub async fn create_challenge(
        ...
        // Canonical message: "XOURCEX_WILL_SIGN:{doc_hash}:{vault_id}:{nonce}"
        let message = format!(
            "XOURCEX_WILL_SIGN:{}:{}:{}",
    ...
    pub fn build_message(document_hash: &str, vault_id: &str, nonce: &str) -> String {
        format!("XOURCEX_WILL_SIGN:{document_hash}:{vault_id}:{nonce}")
    }
...
mod tests {
    ...
    fn test_build_message_format() {
        ...
        assert_eq!(msg, "XOURCEX_WILL_SIGN:hash123:vault-1:nonce-abc");
    }
    ...
    fn test_verify_valid_signature() {
        ...
        let message = "XOURCEX_WILL_SIGN:abc:vault-1:nonce-xyz";
    ...
    fn test_reject_wrong_message() {
        ...
        assert!(WillSignatureService::verify_signature(
            &wallet_address,
            "XOURCEX_WILL_SIGN:different:vault-1:nonce-xyz",
            &sig_hex
        )
        .is_err());
    }
