...
A Rust-based backend for the XOURCEX crypto system, built on Stellar network with Soroban smart contracts.

## Architecture

The XOURCEX backend provides the following services:
...
3. Environment variables with `XOURCEX_` prefix
...
This project is part of the XOURCEX ecosystem.