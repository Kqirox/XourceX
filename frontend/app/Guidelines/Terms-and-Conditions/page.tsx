        ...
        <div className="pt-5 md:pt-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-[#92A5A8]">
              Here are some important social dynamics about XourceX
            </p>
          </div>
                    ...
                    <div className="flex flex-col md:flex-row space-y-[30px] md:space-y-0 md:gap-8">
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm mb-3">
                          By Using XourceX, You Agree To These Terms And
                        ...
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            ...
                            <span>
                              These Terms Govern Your Use Of The XourceX
                              Platform
                            </span>
                          </li>
                          <li className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm mb-3">
                          XourceX Reserves The Right To Modify These Terms At
                  ...
                  <div className="border-t-2 mb-10 border-[#1C252A] pt-2">
                    ...
                    <div className="flex flex-col md:flex-row space-y-[30px] md:space-y-0 md:gap-8">
                      <div className="flex-1">
                        ...
                        <ul className="space-y-2 text-slate-300">
                          ...
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                            <span>
                              Notify XourceX Immediately Of Any Unauthorized
                              Access
                            </span>
                          </li>
                          <li className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm mb-3">
                          XourceX Commits To Protecting User Data Through:
                        </p>
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                  ...
                  <div className="border-t-2 mb-10 border-[#1C252A] pt-2">
                    ...
                    <div className="flex flex-col md:flex-row space-y-[30px] md:space-y-0 md:gap-8">
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm mb-3">
                          XourceX&apos;s Liability Is Limited As Follows:
                        </p>
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="space-y-2 text-slate-300">
                          ...
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                            <span>
                              Indemnifying XourceX Against Claims Arising From
                              User Actions
                            </span>
                          </li>
                        </ul>
                    ...
                    <div className="flex flex-col md:flex-row space-y-[30px] md:space-y-0 md:gap-8">
                      <div className="flex-1">
                        ...
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                            <span>Contact XourceX Support Team First</span>
                          </li>
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                            <span>
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
                            <span>
                              Laws Of The Jurisdiction Where XourceX Is
                              Registered
                            </span>
                          </li>
                          <li className="flex items-start">
                  ...
                  <div className="border-t-2 mb-10 border-[#1C252A] pt-2">
                    ...
                    <div className="flex flex-col md:flex-row space-y-[30px] md:space-y-0 md:gap-8">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-400 text-sm mb-3">
                          XourceX May Terminate Accounts For:
                        </p>
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start">
                            <span className="mr-2">›</span>
