  ...
  return (
    <div className="min-h-screen bg-[#161E22] text-slate-300 relative overflow-hidden">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-12 relative z-10">
        ...
        >
          XourceX is a blockchain-powered platform dedicated to redefining how digital assets are secured and passed down. We combine security, transparency, and automation to ensure your crypto and NFTs are protected for generations.
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Founded by a team of blockchain experts at Skill Mind, XourceX was created to bridge the gap between traditional estate planning and the digital economy. We provide a secure, decentralized solution that ensures digital assets are protected, preserved, and passed on with efficiency and transparency.
        </motion.p>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 relative z-10">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-sm text-[#92A5A8] leading-relaxed">
              We believe digital assets deserve the same trust, security, and transparency as traditional assets. XourceX is dedicated to building a decentralized inheritance platform that empowers users to protect and transfer their digital wealth with confidence.
            </p>
          </motion.div>
        </div>
