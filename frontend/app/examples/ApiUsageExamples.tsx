...
import { api, AdminAPI, AdminMetrics } from "@/app/lib/api";
...
export function MetricsDisplay() {
  const { data, loading, error, refetch } = useApi<AdminMetrics>(
...
export function LiveMetrics() {
  const { data, loading, refetch } = useApi<AdminMetrics>(() => api.admin.getMetrics());
