...
const defaultSEO = {
  siteName: "XourceX",
  domain: "https://xourcex.com",
  defaultTitle: "XourceX - Secure Wealth Inheritance & Asset Planning",
  defaultDescription:
...
export function generateSEO({
  ...
  const metadata: Metadata = {
    ...
    authors: author ? [{ name: author }] : [{ name: "XourceX Team" }],
    creator: "XourceX",
    publisher: "XourceX",
    robots: noindex
      ? "noindex, nofollow"
